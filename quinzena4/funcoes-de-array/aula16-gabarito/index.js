...
function imprimirDespesas(){
    ...
    const addDespesas = (despesas) => {
        divDespesas.innerHTML += `<p>Valor: ${despesas.valor} | Tipo: ${despesas.tipo} | Descrição: ${despesas.descricao}</p>`
    }

    arrDespesas.forEach(addDespesas)
}
...
function imprimirExtrato(){
    ...
    const extrato = (despesas) => {
        if(despesas.tipo === "alimentação"){
            gastoAlimentacao = gastoAlimentacao + despesas.valor
            gastoTotal = gastoTotal + despesas.valor
        }else if(despesas.tipo === "utilidades"){
            gastoUtilidades = gastoUtilidades + despesas.valor
            gastoTotal = gastoTotal + despesas.valor
        }else if(despesas.tipo === "viagem"){
            gastoViagem = gastoViagem + despesas.valor
            gastoTotal = gastoTotal + despesas.valor
        }
    }
